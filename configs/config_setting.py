...
class setting_config:
    ...
    # datasets = 'ISIC2017_REFUGE2_TN3K_merge'
    datasets = 'ClinicDB_ColonDB_ETIS_merge'


    if datasets == 'ISIC2017_REFUGE2_TN3K_merge':
        datasets_name = ['ISIC2017', 'REFUGE2', 'TN3K']
        model_config['num_classes'] = [1, 2, 1]
        data_path_1 = './dataset/isic2017/'
        data_path_2 = './dataset/REFUGE2/'
        data_path_3 = './dataset/TN3K/'
    elif datasets == 'ClinicDB_ColonDB_ETIS_merge':
        datasets_name = ['ClinicDB', 'ColonDB', 'ETIS']
        model_config['num_classes'] = [1, 1, 1]
        data_path_1 = '/home/jnu/wlc/HME-Net/dataset/xirou/data/CVC-ClinicDB/'
        data_path_2 = '/home/jnu/wlc/HME-Net/dataset/xirou/data/CVC-ColonDB/'
        data_path_3 = '/home/jnu/wlc/HME-Net/dataset/xirou/data/ETIS/'
    else:
        raise Exception('datasets in not right!')

    criterion = BceDiceLoss(ignore_background=True)
